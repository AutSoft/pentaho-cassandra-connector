...
public class CassandraInputDialog extends BaseStepDialog implements StepDialogInterface {
    ...
    public String open() {
        ...
        this.wCompression.addModifyListener(e -> CommonDialog.setCompressionTooltips(wCompression, CassandraInputDialog.PKG));
        this.wCompression.addModifyListener(lsMod);
        fd = new FormData();
        fd.left = new FormAttachment(middle, 0);
        fd.top = new FormAttachment(this.wTruststorepass, 4);
        ...
        this.wtCql.addModifyListener(arg0 -> {
        ...
        this.lsCancel = e -> CassandraInputDialog.this.cancel();
        this.lsPreview = e -> CassandraInputDialog.this.preview();
        this.lsOK = e -> CassandraInputDialog.this.ok();
        Listener lsDatafrom = e -> CassandraInputDialog.this.setFlags();
        ...
        this.shell.addShellListener(new ShellAdapter() {
            public void shellClosed(ShellEvent e) {
                CassandraInputDialog.this.checkCancel(e);
            }
        });
    ...
    private void getData() {
        ...
        if (!Utils.isEmpty(this.meta.getCqlStatement())) {
    ...
    private void getInfo(CassandraInputMeta meta, boolean preview) {
        ...
        meta.setCqlStatement((preview) && (!Utils.isEmpty(this.wtCql.getSelectionText())) ? this.wtCql.getSelectionText() : this.wtCql.getText());
        meta.setRowLimit(Utils.isEmpty(this.wLimit.getText()) ? 0 : Integer.parseInt(this.wLimit.getText()));
    ...
    private void setFlags() {
        if (!Utils.isEmpty(this.wcDatafrom.getText())) {
